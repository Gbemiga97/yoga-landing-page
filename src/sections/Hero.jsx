...
const Hero = () => {
  return (
    ...
    lg:bg-circle lg:bg-no-repeat lg:bg-right-top ">
        ...
        <div className="flex flex-col items-center lg:flex-row lg:items-start pt-32">
          <div className="flex-1 lg:mt-12">
            ...
            className="mb-6 lg:mb-12 max-w-[480px] lg:text-lg">
              ...
              Counteract the stress of modern life by becoming
            ...
            className="mb-12 space-x-4">
              ...
              border-stroke-1 px-4 hover:border-stroke-3 transition " >
                Learn more</button>
            </div>
          </div>
          ...
          <div className="w-full bg-circle bg-cover lg:bg-none lg:w-auto">
           ...
           className="flex-1 flex justify-center lg:justify-end">
            <div className="w-[234px] h-[234px] lg:w-[540px] lg:h-[744px] lg:mt-0">
              <Parallax className="w-full h-full p-28 lg:p-16"
              bgImage={images.Hero}
